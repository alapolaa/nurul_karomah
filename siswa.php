...
<body>
    ...
    <p>Pas Foto: <a href="<?php echo $berkas['pas_foto']; ?>" target="_blank">Lihat</a></p>
    <p>Ijazah Depan: <a href="<?php echo $berkas['ijazah_depan']; ?>" target="_blank">Lihat</a></p>
    <p>Ijazah Belakang: <a href="<?php echo $berkas['ijazah_belakang']; ?>" target="_blank">Lihat</a></p>
    <p>...</p>
