...
<head>
    <title>Data Pendaftar MTs</title>
</head>

<body>
    <h2>Data Pendaftar MTs</h2>
    ...
    <form method="POST" action="export_pdf.php?jenjang=MTs">
    ...
    <table border="1">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<tr><td colspan='7'>Tidak ada data pendaftar untuk jenjang MTs.</td></tr>";
        }
        ?>
    </table>
</body>
