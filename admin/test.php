        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <a href="../admin/admin/kelola_admin.php" class="nav-item nav-link">Kelola Admin</a>
    ...
    <div class="container-fluid pt-5">
        <div class="container pb-3">
            <div class="text-center pb-2">
                ...
                <a href="tambah.php">Tambah Admin</a><br><br>

                <?php
                if ($result->num_rows > 0) {
                    echo "<table>";
                    echo "<tr><th>Nomor</th><th>Nama</th><th>Email</th><th>Password</th><th>Aksi</th></tr>";
                    $nomor = 1;
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='edit.php?id=" . $row["admin_id"] . "'>Edit</a> | <a href='hapus.php?id=" . $row["admin_id"] . "'>Hapus</a></td>";
                        echo "</tr>";
                        $nomor++;
                    }
                    echo "</table>";
