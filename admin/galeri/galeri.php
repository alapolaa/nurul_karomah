        ...
        <table border="1" style="width: 80%;">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <a href='edit_galeri.php?id=" . $row['galeri_gambar_id'] . "' style='font-size: 12px;'>Edit</a> | 
                    <a href='hapus_galeri.php?id=" . $row['galeri_gambar_id'] . "' style='font-size: 12px;'>Hapus</a>
                </td>";
                    echo "</tr>";
                    $nomor++;
                }
