...
<head>
    <title>Data Pendaftar MA</title>
</head>

<body>
    <h2>Data Pendaftar MA</h2>
    ...
    <form method="POST" action="export_pdf.php?jenjang=MA">
    ...
    <table border="1">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<tr><td colspan='7'>Tidak ada data pendaftar untuk jenjang MA.</td></tr>";
        }
        ?>
    </table>
</body>
